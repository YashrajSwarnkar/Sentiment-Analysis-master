...
# Getting the reviews from the website
def extract_reviews():
    time.sleep(2)
    page = driver.page_source
    soup = BeautifulSoup(page)
...
# reviews are being lemmetized here
...
# negative and positive words arebeing imported
def isNotNull(value):
...
# positive and negative review based on ratings are being calculated
pos_content_rating = []
neg_content_rating = []
...
# positive and negative review based on sentiments are being calculated
